...
Route::middleware(['auth', 'verified', 'user'])->prefix('user')->group(function () {
    ...
    Route::get('/demandes', [UserController::class, 'userDemandes'])->name('user.demandes');
    Route::get('/alerts', [UserController::class, 'getAlerts'])->name('user.alerts');
    Route::get('/demande/afficher/{id}', [DemandeController::class, 'show'])->name('user.demandes.voir');
    Route::get('/demande/remplir/{id}', [DemandeController::class, 'showRemplir'])->name('user.demandes.showRemplir');
    Route::post('/demande/remplir/{id}', [DemandeController::class, 'remplir'])->name('user.demandes.remplir');
    ...
    Route::get('/contrats/{contrat}/download', [ContratController::class, 'downloadPDF'])->name('contrats.downloadPDF');
    ...
    Route::get('/factures/{facture}/download', [FactureController::class, 'downloadPDF'])->name('factures.downloadPDF');
    Route::get('/factures/view/{facture}', [FactureController::class, 'showPublic'])->name('factures.show');
